  ...
  <Layout>
    ...
    <Page>
      ...
      <div>
        ...
        <p>Sharing Personal Informtion</p>
        <p>
        ...
        <p>
          We <strong> DO NOT </strong> engage in fully automated decision-making
          that has a legal or otherwise significant effect using customer data.
        </p>
        <p>
        ...
        <p>
          <i>
            [INCLUDE THE FOLLOWING SECTION ONLY IF YOU SELL PERSONAL
        ...
        <p>
          ...
          by e-mail at info@tresnoir.com or by mail using the details provided
          below:
        </p>
        <p>
          Acme Acetate Company, 2831 W 1st St, Santa Ana CA 92703, United States
        </p>
        <p>
          Last Updated: <i>08-09-2021</i>
        </p>
        <p>
          ...
          <a href="https://oag.ca.gov/privacy" rel="noreferrer" target="_blank">
